...
#------------------------------------
    ...
    def create_xr_Dataset(self, time_format = "%Y-%m-%d %H:%M:%S", user_dims_dict={'status_Neuron_Sensors': 'time', 'NeurNode1ALxt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode1ALxt_psd_max_env': ['time_psd', 'Frequency_psd'], 'NeurNode1ALxt_psd_min_env': ['time_psd', 'Frequency_psd'], 'NeurNode2ALxt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode3ALxt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode3ALxt_psd_max_env': ['time_psd', 'Frequency_psd'], 'NeurNode3ALxt_psd_min_env': ['time_psd', 'Frequency_psd'], 'NeurNode4ALxt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode5ALxt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode6ALxt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode1ALyt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode2ALyt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode3ALyt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode4ALyt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode5ALyt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode6ALyt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode1ALzt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode2ALzt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode3ALzt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode4ALzt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode5ALzt_psd': ['time_psd', 'Frequency_psd'], 'NeurNode6ALzt_psd': ['time_psd', 'Frequency_psd']}):
        xr_ds_l=[]
        xr_ds=[]
        import pandas
